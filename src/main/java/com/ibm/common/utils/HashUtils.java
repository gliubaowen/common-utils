...
public class HashUtils {
	...
	public static String getMemberHash(String memberId) {
		...
		if (!("0".equals(hashValue) || "1".equals(hashValue) || "2".equals(hashValue)||
			  "3".equals(hashValue) || "4".equals(hashValue) || "5".equals(hashValue)||
			  "6".equals(hashValue) || "7".equals(hashValue) || "8".equals(hashValue)||
			  "9".equals(hashValue))) {
			return DEFAULT;
		}
		return "0" + hashValue;
